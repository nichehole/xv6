...
grep(char *pattern, int fd)
{
  ...
  8c:	75 93                	jne    21 <grep+0x21>
    ...
    if(p == buf)
  8e:	81 7d f0 20 0f 00 00 	cmpl   $0xf20,-0x10(%ebp)
  ...
  a2:	7e 29                	jle    cd <grep+0xcd>
      m -= p - buf;
  a4:	ba 20 0f 00 00       	mov    $0xf20,%edx
  ...
  c1:	c7 04 24 20 0f 00 00 	movl   $0xf20,(%esp)
  c8:	e8 ab 04 00 00       	call   578 <memmove>
{
  ...
  dc:	81 c2 20 0f 00 00    	add    $0xf20,%edx
...
main(int argc, char *argv[])
{
 ...
 113:	c7 44 24 04 88 0b 00 	movl   $0xb88,0x4(%esp)
 11a:	00 
 ...
 1a5:	c7 44 24 04 a8 0b 00 	movl   $0xba8,0x4(%esp)
 1ac:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 6de:	0f b6 80 ec 0e 00 00 	movzbl 0xeec(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 83b:	75 09                	jne    846 <printf+0x101>
          s = "(null)";
 83d:	c7 45 f4 be 0b 00 00 	movl   $0xbbe,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 907:	a1 08 0f 00 00       	mov    0xf08,%eax
...
free(void *ap)
{
 ...
 9d2:	a3 08 0f 00 00       	mov    %eax,0xf08
}
 9d7:	c9                   	leave  
 9d8:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 a25:	e8 ce fe ff ff       	call   8f8 <free>
  return freep;
 a2a:	a1 08 0f 00 00       	mov    0xf08,%eax
}
 a2f:	c9                   	leave  
 a30:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 a43:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 a46:	a1 08 0f 00 00       	mov    0xf08,%eax
 a4b:	89 45 f0             	mov    %eax,-0x10(%ebp)
 a4e:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 a52:	75 23                	jne    a77 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 a54:	c7 45 f0 00 0f 00 00 	movl   $0xf00,-0x10(%ebp)
 a5b:	8b 45 f0             	mov    -0x10(%ebp),%eax
 a5e:	a3 08 0f 00 00       	mov    %eax,0xf08
 a63:	a1 08 0f 00 00       	mov    0xf08,%eax
 a68:	a3 00 0f 00 00       	mov    %eax,0xf00
    base.s.size = 0;
 a6d:	c7 05 04 0f 00 00 00 	movl   $0x0,0xf04
 a74:	00 00 00 
  }
 ...
 aca:	a3 08 0f 00 00       	mov    %eax,0xf08
      return (void*)(p + 1);
 ...
 ad5:	eb 38                	jmp    b0f <malloc+0xde>
    ...
    if(p == freep)
 ad7:	a1 08 0f 00 00       	mov    0xf08,%eax
...
void qthread_create(qthread_t *t, void *func, void *arg) {
 ...
 b17:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
 b1e:	e8 0e ff ff ff       	call   a31 <malloc>
 b23:	89 45 f4             	mov    %eax,-0xc(%ebp)
  stack += STACKSIZE;
 b26:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
  *t = threadop(0, func, arg, stack);
 b2d:	8b 45 f4             	mov    -0xc(%ebp),%eax
 b30:	89 44 24 0c          	mov    %eax,0xc(%esp)
 b34:	8b 45 10             	mov    0x10(%ebp),%eax
 b37:	89 44 24 08          	mov    %eax,0x8(%esp)
 b3b:	8b 45 0c             	mov    0xc(%ebp),%eax
 b3e:	89 44 24 04          	mov    %eax,0x4(%esp)
 b42:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
 b49:	e8 0f fb ff ff       	call   65d <threadop>
 b4e:	8b 55 08             	mov    0x8(%ebp),%edx
 b51:	89 02                	mov    %eax,(%edx)
}
 b53:	c9                   	leave  
 b54:	c3                   	ret    

00000b55 <qthread_mutex_init>:
...
int qthread_cond_init(qthread_cond_t *cond, qthread_condattr_t *attr) {
 ...
 b77:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
