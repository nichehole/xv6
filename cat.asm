...
cat(int fd)
{
  ...
  4d:	c7 44 24 04 4d 09 00 	movl   $0x94d,0x4(%esp)
  54:	00 
...
main(int argc, char *argv[])
{
  ...
  d5:	c7 44 24 04 5e 09 00 	movl   $0x95e,0x4(%esp)
  dc:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4a6:	0f b6 80 40 0c 00 00 	movzbl 0xc40(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 603:	75 09                	jne    60e <printf+0x101>
          s = "(null)";
 605:	c7 45 f4 73 09 00 00 	movl   $0x973,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 6cf:	a1 68 0c 00 00       	mov    0xc68,%eax
...
morecore(uint nu)
{
 ...
 7ed:	e8 ce fe ff ff       	call   6c0 <free>
  return freep;
 7f2:	a1 68 0c 00 00       	mov    0xc68,%eax
}
 7f7:	c9                   	leave  
 7f8:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 80b:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 80e:	a1 68 0c 00 00       	mov    0xc68,%eax
 813:	89 45 f0             	mov    %eax,-0x10(%ebp)
 816:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 81a:	75 23                	jne    83f <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 81c:	c7 45 f0 60 0c 00 00 	movl   $0xc60,-0x10(%ebp)
 823:	8b 45 f0             	mov    -0x10(%ebp),%eax
 826:	a3 68 0c 00 00       	mov    %eax,0xc68
 82b:	a1 68 0c 00 00       	mov    0xc68,%eax
 830:	a3 60 0c 00 00       	mov    %eax,0xc60
    base.s.size = 0;
 835:	c7 05 64 0c 00 00 00 	movl   $0x0,0xc64
 83c:	00 00 00 
  }
 ...
 892:	a3 68 0c 00 00       	mov    %eax,0xc68
      return (void*)(p + 1);
...
void qthread_create(qthread_t *t, void *func, void *arg) {
 ...
 8df:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
 8e6:	e8 0e ff ff ff       	call   7f9 <malloc>
 8eb:	89 45 f4             	mov    %eax,-0xc(%ebp)
  stack += STACKSIZE;
 8ee:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
  *t = threadop(0, func, arg, stack);
 8f5:	8b 45 f4             	mov    -0xc(%ebp),%eax
 8f8:	89 44 24 0c          	mov    %eax,0xc(%esp)
 8fc:	8b 45 10             	mov    0x10(%ebp),%eax
 ...
 911:	e8 0f fb ff ff       	call   425 <threadop>
...
int qthread_mutex_init(qthread_mutex_t *mutex, qthread_mutexattr_t *attr) {
 ...
 923:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  return 0;
