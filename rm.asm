...
main(int argc, char *argv[])
{
  ...
  66:	c7 44 24 04 d3 08 00 	movl   $0x8d3,0x4(%esp)
  6d:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 418:	0f b6 80 98 0b 00 00 	movzbl 0xb98(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 575:	75 09                	jne    580 <printf+0x101>
          s = "(null)";
 577:	c7 45 f4 ec 08 00 00 	movl   $0x8ec,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 641:	a1 b4 0b 00 00       	mov    0xbb4,%eax
...
free(void *ap)
{
 ...
 70c:	a3 b4 0b 00 00       	mov    %eax,0xbb4
}
 711:	c9                   	leave  
 712:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 75f:	e8 ce fe ff ff       	call   632 <free>
  return freep;
 764:	a1 b4 0b 00 00       	mov    0xbb4,%eax
}
 769:	c9                   	leave  
 76a:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 77d:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 780:	a1 b4 0b 00 00       	mov    0xbb4,%eax
 785:	89 45 f0             	mov    %eax,-0x10(%ebp)
 788:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 78c:	75 23                	jne    7b1 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 78e:	c7 45 f0 ac 0b 00 00 	movl   $0xbac,-0x10(%ebp)
 795:	8b 45 f0             	mov    -0x10(%ebp),%eax
 798:	a3 b4 0b 00 00       	mov    %eax,0xbb4
 79d:	a1 b4 0b 00 00       	mov    0xbb4,%eax
 7a2:	a3 ac 0b 00 00       	mov    %eax,0xbac
    base.s.size = 0;
 7a7:	c7 05 b0 0b 00 00 00 	movl   $0x0,0xbb0
 7ae:	00 00 00 
  }
 ...
 804:	a3 b4 0b 00 00       	mov    %eax,0xbb4
      return (void*)(p + 1);
 ...
 80f:	eb 38                	jmp    849 <malloc+0xde>
    ...
    if(p == freep)
 811:	a1 b4 0b 00 00       	mov    0xbb4,%eax
...
void qthread_create(qthread_t *t, void *func, void *arg) {
 ...
 851:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
 858:	e8 0e ff ff ff       	call   76b <malloc>
 85d:	89 45 f4             	mov    %eax,-0xc(%ebp)
  stack += STACKSIZE;
 860:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
 ...
 87c:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
 883:	e8 0f fb ff ff       	call   397 <threadop>
...
int qthread_mutex_init(qthread_mutex_t *mutex, qthread_mutexattr_t *attr) {
 ...
 895:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  return 0;
...
int qthread_cond_init(qthread_cond_t *cond, qthread_condattr_t *attr) {
 ...
 8b1:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
