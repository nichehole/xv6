...
fmtname(char *path)
{
  ...
  61:	c7 04 24 e8 0e 00 00 	movl   $0xee8,(%esp)
  ...
  8c:	05 e8 0e 00 00       	add    $0xee8,%eax
  ...
  return buf;
  a5:	b8 e8 0e 00 00       	mov    $0xee8,%eax
}
...
ls(char *path)
{
  ...
  df:	c7 44 24 04 8b 0b 00 	movl   $0xb8b,0x4(%esp)
  e6:	00 
 ...
 118:	c7 44 24 04 9f 0b 00 	movl   $0xb9f,0x4(%esp)
 11f:	00 
 ...
 183:	c7 44 24 04 b3 0b 00 	movl   $0xbb3,0x4(%esp)
 18a:	00 
 ...
 1b1:	c7 44 24 04 c0 0b 00 	movl   $0xbc0,0x4(%esp)
 1b8:	00 
 ...
 269:	c7 44 24 04 9f 0b 00 	movl   $0xb9f,0x4(%esp)
 270:	00 
 ...
 2b3:	c7 44 24 04 b3 0b 00 	movl   $0xbb3,0x4(%esp)
 2ba:	00 
...
main(int argc, char *argv[])
{
 ...
 311:	7f 11                	jg     324 <main+0x20>
    ls(".");
 313:	c7 04 24 d3 0b 00 00 	movl   $0xbd3,(%esp)
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 6e4:	0f b6 80 d4 0e 00 00 	movzbl 0xed4(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 841:	75 09                	jne    84c <printf+0x101>
          s = "(null)";
 843:	c7 45 f4 d5 0b 00 00 	movl   $0xbd5,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 90d:	a1 00 0f 00 00       	mov    0xf00,%eax
...
free(void *ap)
{
 ...
 9d8:	a3 00 0f 00 00       	mov    %eax,0xf00
}
 9dd:	c9                   	leave  
 9de:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 a2b:	e8 ce fe ff ff       	call   8fe <free>
  return freep;
 a30:	a1 00 0f 00 00       	mov    0xf00,%eax
}
 a35:	c9                   	leave  
 a36:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 a49:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 a4c:	a1 00 0f 00 00       	mov    0xf00,%eax
 a51:	89 45 f0             	mov    %eax,-0x10(%ebp)
 a54:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 a58:	75 23                	jne    a7d <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 a5a:	c7 45 f0 f8 0e 00 00 	movl   $0xef8,-0x10(%ebp)
 a61:	8b 45 f0             	mov    -0x10(%ebp),%eax
 a64:	a3 00 0f 00 00       	mov    %eax,0xf00
 a69:	a1 00 0f 00 00       	mov    0xf00,%eax
 a6e:	a3 f8 0e 00 00       	mov    %eax,0xef8
    base.s.size = 0;
 a73:	c7 05 fc 0e 00 00 00 	movl   $0x0,0xefc
 a7a:	00 00 00 
  }
 ...
 ad0:	a3 00 0f 00 00       	mov    %eax,0xf00
      return (void*)(p + 1);
 ...
 adb:	eb 38                	jmp    b15 <malloc+0xde>
    ...
    if(p == freep)
 add:	a1 00 0f 00 00       	mov    0xf00,%eax
...
void qthread_create(qthread_t *t, void *func, void *arg) {
 ...
 b1d:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
 b24:	e8 0e ff ff ff       	call   a37 <malloc>
 b29:	89 45 f4             	mov    %eax,-0xc(%ebp)
  stack += STACKSIZE;
 b2c:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
  *t = threadop(0, func, arg, stack);
 b33:	8b 45 f4             	mov    -0xc(%ebp),%eax
 b36:	89 44 24 0c          	mov    %eax,0xc(%esp)
 b3a:	8b 45 10             	mov    0x10(%ebp),%eax
 b3d:	89 44 24 08          	mov    %eax,0x8(%esp)
 b41:	8b 45 0c             	mov    0xc(%ebp),%eax
 b44:	89 44 24 04          	mov    %eax,0x4(%esp)
 b48:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
 b4f:	e8 0f fb ff ff       	call   663 <threadop>
...
int qthread_mutex_init(qthread_mutex_t *mutex, qthread_mutexattr_t *attr) {
 ...
 b61:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  return 0;
...
int qthread_cond_init(qthread_cond_t *cond, qthread_condattr_t *attr) {
 ...
 b74:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  cond->waiting.tail = 0;
