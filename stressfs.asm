...
main(int argc, char *argv[])
{
  ...
  2c:	c7 44 24 04 e3 09 00 	movl   $0x9e3,0x4(%esp)
  33:	00 
  ...
  91:	c7 44 24 04 f6 09 00 	movl   $0x9f6,0x4(%esp)
  98:	00 
...
//    printf(fd, "%d\n", i);
 ...
 125:	e8 19 03 00 00       	call   443 <close>
  ...
  printf(1, "read\n");
 12a:	c7 44 24 04 00 0a 00 	movl   $0xa00,0x4(%esp)
 131:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 53c:	0f b6 80 b4 0c 00 00 	movzbl 0xcb4(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 699:	75 09                	jne    6a4 <printf+0x101>
          s = "(null)";
 69b:	c7 45 f4 06 0a 00 00 	movl   $0xa06,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 765:	a1 d0 0c 00 00       	mov    0xcd0,%eax
...
free(void *ap)
{
 ...
 830:	a3 d0 0c 00 00       	mov    %eax,0xcd0
}
 835:	c9                   	leave  
 836:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 883:	e8 ce fe ff ff       	call   756 <free>
  return freep;
 888:	a1 d0 0c 00 00       	mov    0xcd0,%eax
}
 88d:	c9                   	leave  
 88e:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 8a1:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 8a4:	a1 d0 0c 00 00       	mov    0xcd0,%eax
 8a9:	89 45 f0             	mov    %eax,-0x10(%ebp)
 8ac:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 8b0:	75 23                	jne    8d5 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 8b2:	c7 45 f0 c8 0c 00 00 	movl   $0xcc8,-0x10(%ebp)
 8b9:	8b 45 f0             	mov    -0x10(%ebp),%eax
 8bc:	a3 d0 0c 00 00       	mov    %eax,0xcd0
 8c1:	a1 d0 0c 00 00       	mov    0xcd0,%eax
 8c6:	a3 c8 0c 00 00       	mov    %eax,0xcc8
    base.s.size = 0;
 8cb:	c7 05 cc 0c 00 00 00 	movl   $0x0,0xccc
 8d2:	00 00 00 
  }
 ...
 928:	a3 d0 0c 00 00       	mov    %eax,0xcd0
      return (void*)(p + 1);
 ...
 933:	eb 38                	jmp    96d <malloc+0xde>
    ...
    if(p == freep)
 935:	a1 d0 0c 00 00       	mov    0xcd0,%eax
...
void qthread_create(qthread_t *t, void *func, void *arg) {
 ...
 975:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
 97c:	e8 0e ff ff ff       	call   88f <malloc>
 981:	89 45 f4             	mov    %eax,-0xc(%ebp)
  stack += STACKSIZE;
 984:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
  *t = threadop(0, func, arg, stack);
 98b:	8b 45 f4             	mov    -0xc(%ebp),%eax
 98e:	89 44 24 0c          	mov    %eax,0xc(%esp)
 992:	8b 45 10             	mov    0x10(%ebp),%eax
 995:	89 44 24 08          	mov    %eax,0x8(%esp)
 999:	8b 45 0c             	mov    0xc(%ebp),%eax
 99c:	89 44 24 04          	mov    %eax,0x4(%esp)
 9a0:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
 9a7:	e8 0f fb ff ff       	call   4bb <threadop>
 9ac:	8b 55 08             	mov    0x8(%ebp),%edx
 9af:	89 02                	mov    %eax,(%edx)
}
 9b1:	c9                   	leave  
 9b2:	c3                   	ret    

000009b3 <qthread_mutex_init>:
...
int qthread_mutex_init(qthread_mutex_t *mutex, qthread_mutexattr_t *attr) {
 ...
 9b9:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  return 0;
