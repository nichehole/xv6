...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3ac:	0f b6 80 00 0b 00 00 	movzbl 0xb00(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 509:	75 09                	jne    514 <printf+0x101>
          s = "(null)";
 50b:	c7 45 f4 53 08 00 00 	movl   $0x853,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 5d5:	a1 1c 0b 00 00       	mov    0xb1c,%eax
...
free(void *ap)
{
 ...
 6a0:	a3 1c 0b 00 00       	mov    %eax,0xb1c
}
 6a5:	c9                   	leave  
 6a6:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 711:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 714:	a1 1c 0b 00 00       	mov    0xb1c,%eax
 719:	89 45 f0             	mov    %eax,-0x10(%ebp)
 71c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 720:	75 23                	jne    745 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 722:	c7 45 f0 14 0b 00 00 	movl   $0xb14,-0x10(%ebp)
 729:	8b 45 f0             	mov    -0x10(%ebp),%eax
 72c:	a3 1c 0b 00 00       	mov    %eax,0xb1c
 731:	a1 1c 0b 00 00       	mov    0xb1c,%eax
 736:	a3 14 0b 00 00       	mov    %eax,0xb14
    base.s.size = 0;
 73b:	c7 05 18 0b 00 00 00 	movl   $0x0,0xb18
 742:	00 00 00 
  }
 ...
 798:	a3 1c 0b 00 00       	mov    %eax,0xb1c
      return (void*)(p + 1);
 ...
 7a3:	eb 38                	jmp    7dd <malloc+0xde>
    ...
    if(p == freep)
 7a5:	a1 1c 0b 00 00       	mov    0xb1c,%eax
...
void qthread_create(qthread_t *t, void *func, void *arg) {
 ...
 7e5:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
 7ec:	e8 0e ff ff ff       	call   6ff <malloc>
 7f1:	89 45 f4             	mov    %eax,-0xc(%ebp)
  stack += STACKSIZE;
 7f4:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
  *t = threadop(0, func, arg, stack);
 7fb:	8b 45 f4             	mov    -0xc(%ebp),%eax
 7fe:	89 44 24 0c          	mov    %eax,0xc(%esp)
 802:	8b 45 10             	mov    0x10(%ebp),%eax
 805:	89 44 24 08          	mov    %eax,0x8(%esp)
 809:	8b 45 0c             	mov    0xc(%ebp),%eax
 80c:	89 44 24 04          	mov    %eax,0x4(%esp)
 810:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
 817:	e8 0f fb ff ff       	call   32b <threadop>
 81c:	8b 55 08             	mov    0x8(%ebp),%edx
 81f:	89 02                	mov    %eax,(%edx)
}
 821:	c9                   	leave  
 822:	c3                   	ret    

00000823 <qthread_mutex_init>:
...
int qthread_mutex_init(qthread_mutex_t *mutex, qthread_mutexattr_t *attr) {
 ...
 829:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  return 0;
...
int qthread_cond_init(qthread_cond_t *cond, qthread_condattr_t *attr) {
 ...
 845:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
