...
wc(int fd, char *name)
{
  ...
  54:	c7 04 24 09 0a 00 00 	movl   $0xa09,(%esp)
  ...
  91:	00 
  92:	c7 44 24 04 40 0d 00 	movl   $0xd40,0x4(%esp)
  99:	00 
  ...
  b8:	c7 44 24 04 0f 0a 00 	movl   $0xa0f,0x4(%esp)
  bf:	00 
  ...
  ed:	c7 44 24 04 1f 0a 00 	movl   $0xa1f,0x4(%esp)
  f4:	00 
...
main(int argc, char *argv[])
{
 ...
 110:	7f 19                	jg     12b <main+0x28>
    wc(0, "");
 112:	c7 44 24 04 2c 0a 00 	movl   $0xa2c,0x4(%esp)
 119:	00 
 ...
 17b:	c7 44 24 04 2d 0a 00 	movl   $0xa2d,0x4(%esp)
 182:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 562:	0f b6 80 0c 0d 00 00 	movzbl 0xd0c(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 6bf:	75 09                	jne    6ca <printf+0x101>
          s = "(null)";
 6c1:	c7 45 f4 41 0a 00 00 	movl   $0xa41,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 78b:	a1 28 0d 00 00       	mov    0xd28,%eax
...
free(void *ap)
{
 ...
 856:	a3 28 0d 00 00       	mov    %eax,0xd28
}
 85b:	c9                   	leave  
 85c:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 8a9:	e8 ce fe ff ff       	call   77c <free>
  return freep;
 8ae:	a1 28 0d 00 00       	mov    0xd28,%eax
}
 8b3:	c9                   	leave  
 8b4:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 8c7:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 8ca:	a1 28 0d 00 00       	mov    0xd28,%eax
 8cf:	89 45 f0             	mov    %eax,-0x10(%ebp)
 8d2:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 8d6:	75 23                	jne    8fb <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 8d8:	c7 45 f0 20 0d 00 00 	movl   $0xd20,-0x10(%ebp)
 8df:	8b 45 f0             	mov    -0x10(%ebp),%eax
 8e2:	a3 28 0d 00 00       	mov    %eax,0xd28
 8e7:	a1 28 0d 00 00       	mov    0xd28,%eax
 8ec:	a3 20 0d 00 00       	mov    %eax,0xd20
    base.s.size = 0;
 8f1:	c7 05 24 0d 00 00 00 	movl   $0x0,0xd24
 8f8:	00 00 00 
  }
 ...
 94e:	a3 28 0d 00 00       	mov    %eax,0xd28
      return (void*)(p + 1);
 ...
 959:	eb 38                	jmp    993 <malloc+0xde>
    ...
    if(p == freep)
 95b:	a1 28 0d 00 00       	mov    0xd28,%eax
...
void qthread_create(qthread_t *t, void *func, void *arg) {
 ...
 9a2:	e8 0e ff ff ff       	call   8b5 <malloc>
 9a7:	89 45 f4             	mov    %eax,-0xc(%ebp)
  stack += STACKSIZE;
 9aa:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
  *t = threadop(0, func, arg, stack);
 9b1:	8b 45 f4             	mov    -0xc(%ebp),%eax
 9b4:	89 44 24 0c          	mov    %eax,0xc(%esp)
 9b8:	8b 45 10             	mov    0x10(%ebp),%eax
 ...
 9cd:	e8 0f fb ff ff       	call   4e1 <threadop>
 9d2:	8b 55 08             	mov    0x8(%ebp),%edx
 9d5:	89 02                	mov    %eax,(%edx)
}
 9d7:	c9                   	leave  
 9d8:	c3                   	ret    

000009d9 <qthread_mutex_init>:
...
int qthread_mutex_init(qthread_mutex_t *mutex, qthread_mutexattr_t *attr) {
 ...
 9df:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  return 0;
