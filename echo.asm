...
main(int argc, char *argv[])
{
  ...
  1f:	b8 9c 08 00 00       	mov    $0x89c,%eax
  24:	eb 05                	jmp    2b <main+0x2b>
  26:	b8 9e 08 00 00       	mov    $0x89e,%eax
  ...
  45:	c7 44 24 04 a0 08 00 	movl   $0x8a0,0x4(%esp)
  4c:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3f5:	0f b6 80 50 0b 00 00 	movzbl 0xb50(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 552:	75 09                	jne    55d <printf+0x101>
          s = "(null)";
 554:	c7 45 f4 a5 08 00 00 	movl   $0x8a5,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 61e:	a1 6c 0b 00 00       	mov    0xb6c,%eax
...
morecore(uint nu)
{
 ...
 73c:	e8 ce fe ff ff       	call   60f <free>
  return freep;
 741:	a1 6c 0b 00 00       	mov    0xb6c,%eax
}
 746:	c9                   	leave  
 747:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 75a:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 75d:	a1 6c 0b 00 00       	mov    0xb6c,%eax
 762:	89 45 f0             	mov    %eax,-0x10(%ebp)
 765:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 769:	75 23                	jne    78e <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 76b:	c7 45 f0 64 0b 00 00 	movl   $0xb64,-0x10(%ebp)
 772:	8b 45 f0             	mov    -0x10(%ebp),%eax
 775:	a3 6c 0b 00 00       	mov    %eax,0xb6c
 77a:	a1 6c 0b 00 00       	mov    0xb6c,%eax
 77f:	a3 64 0b 00 00       	mov    %eax,0xb64
    base.s.size = 0;
 784:	c7 05 68 0b 00 00 00 	movl   $0x0,0xb68
 78b:	00 00 00 
  }
 ...
 7e1:	a3 6c 0b 00 00       	mov    %eax,0xb6c
      return (void*)(p + 1);
 ...
 7ec:	eb 38                	jmp    826 <malloc+0xde>
    ...
    if(p == freep)
 7ee:	a1 6c 0b 00 00       	mov    0xb6c,%eax
...
void qthread_create(qthread_t *t, void *func, void *arg) {
 ...
 82e:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
 835:	e8 0e ff ff ff       	call   748 <malloc>
 83a:	89 45 f4             	mov    %eax,-0xc(%ebp)
  stack += STACKSIZE;
 83d:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
  *t = threadop(0, func, arg, stack);
 844:	8b 45 f4             	mov    -0xc(%ebp),%eax
 847:	89 44 24 0c          	mov    %eax,0xc(%esp)
 84b:	8b 45 10             	mov    0x10(%ebp),%eax
 84e:	89 44 24 08          	mov    %eax,0x8(%esp)
 852:	8b 45 0c             	mov    0xc(%ebp),%eax
 855:	89 44 24 04          	mov    %eax,0x4(%esp)
 859:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
 860:	e8 0f fb ff ff       	call   374 <threadop>
...
int qthread_mutex_init(qthread_mutex_t *mutex, qthread_mutexattr_t *attr) {
 ...
 872:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  return 0;
...
int qthread_cond_init(qthread_cond_t *cond, qthread_condattr_t *attr) {
 ...
 885:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  cond->waiting.tail = 0;
