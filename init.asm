...
main(void)
{
  ...
  10:	00 
  11:	c7 04 24 42 09 00 00 	movl   $0x942,(%esp)
  ...
  30:	00 
  31:	c7 04 24 42 09 00 00 	movl   $0x942,(%esp)
  38:	e8 82 03 00 00       	call   3bf <mknod>
    open("console", O_RDWR);
  3d:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
  44:	00 
  45:	c7 04 24 42 09 00 00 	movl   $0x942,(%esp)
  ...
  69:	c7 44 24 04 4a 09 00 	movl   $0x94a,0x4(%esp)
  70:	00 
  ...
  8d:	c7 44 24 04 5d 09 00 	movl   $0x95d,0x4(%esp)
  94:	00 
  ...
  ab:	75 2d                	jne    da <main+0xda>
      exec("sh", argv);
  ad:	c7 44 24 04 3c 0c 00 	movl   $0xc3c,0x4(%esp)
  b4:	00 
  b5:	c7 04 24 3f 09 00 00 	movl   $0x93f,(%esp)
  bc:	e8 ee 02 00 00       	call   3af <exec>
      printf(1, "init: exec sh failed\n");
  c1:	c7 44 24 04 70 09 00 	movl   $0x970,0x4(%esp)
  c8:	00 
  ...
  da:	eb 14                	jmp    f0 <main+0xf0>
      printf(1, "zombie!\n");
  dc:	c7 44 24 04 86 09 00 	movl   $0x986,0x4(%esp)
  e3:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 498:	0f b6 80 44 0c 00 00 	movzbl 0xc44(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 5f5:	75 09                	jne    600 <printf+0x101>
          s = "(null)";
 5f7:	c7 45 f4 8f 09 00 00 	movl   $0x98f,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 6c1:	a1 60 0c 00 00       	mov    0xc60,%eax
...
free(void *ap)
{
 ...
 78c:	a3 60 0c 00 00       	mov    %eax,0xc60
}
 791:	c9                   	leave  
 792:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 7df:	e8 ce fe ff ff       	call   6b2 <free>
  return freep;
 7e4:	a1 60 0c 00 00       	mov    0xc60,%eax
}
 7e9:	c9                   	leave  
 7ea:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 7fd:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 800:	a1 60 0c 00 00       	mov    0xc60,%eax
 805:	89 45 f0             	mov    %eax,-0x10(%ebp)
 808:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 80c:	75 23                	jne    831 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 80e:	c7 45 f0 58 0c 00 00 	movl   $0xc58,-0x10(%ebp)
 815:	8b 45 f0             	mov    -0x10(%ebp),%eax
 818:	a3 60 0c 00 00       	mov    %eax,0xc60
 81d:	a1 60 0c 00 00       	mov    0xc60,%eax
 822:	a3 58 0c 00 00       	mov    %eax,0xc58
    base.s.size = 0;
 ...
 884:	a3 60 0c 00 00       	mov    %eax,0xc60
      return (void*)(p + 1);
 ...
 88f:	eb 38                	jmp    8c9 <malloc+0xde>
    ...
    if(p == freep)
 891:	a1 60 0c 00 00       	mov    0xc60,%eax
...
void qthread_create(qthread_t *t, void *func, void *arg) {
 ...
 8d1:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
 8d8:	e8 0e ff ff ff       	call   7eb <malloc>
 8dd:	89 45 f4             	mov    %eax,-0xc(%ebp)
  stack += STACKSIZE;
 8e0:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
  *t = threadop(0, func, arg, stack);
 8e7:	8b 45 f4             	mov    -0xc(%ebp),%eax
 8ea:	89 44 24 0c          	mov    %eax,0xc(%esp)
 ...
 903:	e8 0f fb ff ff       	call   417 <threadop>
...
int qthread_mutex_init(qthread_mutex_t *mutex, qthread_mutexattr_t *attr) {
 ...
 915:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  return 0;
