...
main(int argc, char *argv[])
{
  ...
  if(argc != 3){
   ...
   f:	c7 44 24 04 a9 08 00 	movl   $0x8a9,0x4(%esp)
  16:	00 
  ...
  60:	c7 44 24 04 bc 08 00 	movl   $0x8bc,0x4(%esp)
  67:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 402:	0f b6 80 7c 0b 00 00 	movzbl 0xb7c(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 55f:	75 09                	jne    56a <printf+0x101>
          s = "(null)";
 561:	c7 45 f4 d0 08 00 00 	movl   $0x8d0,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 62b:	a1 98 0b 00 00       	mov    0xb98,%eax
...
free(void *ap)
{
 ...
 6f6:	a3 98 0b 00 00       	mov    %eax,0xb98
}
 6fb:	c9                   	leave  
 6fc:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 749:	e8 ce fe ff ff       	call   61c <free>
  return freep;
 74e:	a1 98 0b 00 00       	mov    0xb98,%eax
}
 753:	c9                   	leave  
 754:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 767:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 76a:	a1 98 0b 00 00       	mov    0xb98,%eax
 76f:	89 45 f0             	mov    %eax,-0x10(%ebp)
 772:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 776:	75 23                	jne    79b <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 778:	c7 45 f0 90 0b 00 00 	movl   $0xb90,-0x10(%ebp)
 77f:	8b 45 f0             	mov    -0x10(%ebp),%eax
 782:	a3 98 0b 00 00       	mov    %eax,0xb98
 787:	a1 98 0b 00 00       	mov    0xb98,%eax
 78c:	a3 90 0b 00 00       	mov    %eax,0xb90
    base.s.size = 0;
 791:	c7 05 94 0b 00 00 00 	movl   $0x0,0xb94
 798:	00 00 00 
  }
 ...
 7ee:	a3 98 0b 00 00       	mov    %eax,0xb98
      return (void*)(p + 1);
 ...
 7f9:	eb 38                	jmp    833 <malloc+0xde>
    ...
    if(p == freep)
 7fb:	a1 98 0b 00 00       	mov    0xb98,%eax
...
void qthread_create(qthread_t *t, void *func, void *arg) {
 ...
 83b:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
 842:	e8 0e ff ff ff       	call   755 <malloc>
 847:	89 45 f4             	mov    %eax,-0xc(%ebp)
  stack += STACKSIZE;
 84a:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
 ...
 86d:	e8 0f fb ff ff       	call   381 <threadop>
 872:	8b 55 08             	mov    0x8(%ebp),%edx
 875:	89 02                	mov    %eax,(%edx)
}
 877:	c9                   	leave  
 878:	c3                   	ret    

00000879 <qthread_mutex_init>:
...
int qthread_cond_init(qthread_cond_t *cond, qthread_condattr_t *attr) {
 ...
 892:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  cond->waiting.tail = 0;
 898:	8b 45 08             	mov    0x8(%ebp),%eax
 89b:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
