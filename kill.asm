...
main(int argc, char **argv)
{
  ...
  if(argc < 1){
   ...
   f:	c7 44 24 04 97 08 00 	movl   $0x897,0x4(%esp)
  16:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3f0:	0f b6 80 58 0b 00 00 	movzbl 0xb58(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 54d:	75 09                	jne    558 <printf+0x101>
          s = "(null)";
 54f:	c7 45 f4 ab 08 00 00 	movl   $0x8ab,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 619:	a1 74 0b 00 00       	mov    0xb74,%eax
...
free(void *ap)
{
 ...
 6e4:	a3 74 0b 00 00       	mov    %eax,0xb74
}
 6e9:	c9                   	leave  
 6ea:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 737:	e8 ce fe ff ff       	call   60a <free>
  return freep;
 73c:	a1 74 0b 00 00       	mov    0xb74,%eax
}
 741:	c9                   	leave  
 742:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 755:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 758:	a1 74 0b 00 00       	mov    0xb74,%eax
 75d:	89 45 f0             	mov    %eax,-0x10(%ebp)
 760:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 764:	75 23                	jne    789 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 766:	c7 45 f0 6c 0b 00 00 	movl   $0xb6c,-0x10(%ebp)
 76d:	8b 45 f0             	mov    -0x10(%ebp),%eax
 770:	a3 74 0b 00 00       	mov    %eax,0xb74
 775:	a1 74 0b 00 00       	mov    0xb74,%eax
 77a:	a3 6c 0b 00 00       	mov    %eax,0xb6c
    base.s.size = 0;
 77f:	c7 05 70 0b 00 00 00 	movl   $0x0,0xb70
 786:	00 00 00 
  }
 ...
 7dc:	a3 74 0b 00 00       	mov    %eax,0xb74
      return (void*)(p + 1);
 ...
 7e7:	eb 38                	jmp    821 <malloc+0xde>
    ...
    if(p == freep)
 7e9:	a1 74 0b 00 00       	mov    0xb74,%eax
...
void qthread_create(qthread_t *t, void *func, void *arg) {
 ...
 829:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
 830:	e8 0e ff ff ff       	call   743 <malloc>
 835:	89 45 f4             	mov    %eax,-0xc(%ebp)
  stack += STACKSIZE;
 838:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
 ...
 854:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
 85b:	e8 0f fb ff ff       	call   36f <threadop>
 860:	8b 55 08             	mov    0x8(%ebp),%edx
 863:	89 02                	mov    %eax,(%edx)
}
 865:	c9                   	leave  
 866:	c3                   	ret    

00000867 <qthread_mutex_init>:
...
int qthread_mutex_init(qthread_mutex_t *mutex, qthread_mutexattr_t *attr) {
 ...
 86d:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  return 0;
...
int qthread_cond_init(qthread_cond_t *cond, qthread_condattr_t *attr) {
 ...
 880:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  cond->waiting.tail = 0;
 886:	8b 45 08             	mov    0x8(%ebp),%eax
 889:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
