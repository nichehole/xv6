...
main(int argc, char *argv[])
{
  ...
  66:	c7 44 24 04 d6 08 00 	movl   $0x8d6,0x4(%esp)
  6d:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 418:	0f b6 80 a0 0b 00 00 	movzbl 0xba0(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 575:	75 09                	jne    580 <printf+0x101>
          s = "(null)";
 577:	c7 45 f4 f2 08 00 00 	movl   $0x8f2,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 641:	a1 bc 0b 00 00       	mov    0xbbc,%eax
...
free(void *ap)
{
 ...
 70c:	a3 bc 0b 00 00       	mov    %eax,0xbbc
}
 711:	c9                   	leave  
 712:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 75f:	e8 ce fe ff ff       	call   632 <free>
  return freep;
 764:	a1 bc 0b 00 00       	mov    0xbbc,%eax
}
 769:	c9                   	leave  
 76a:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 77d:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 780:	a1 bc 0b 00 00       	mov    0xbbc,%eax
 785:	89 45 f0             	mov    %eax,-0x10(%ebp)
 788:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 78c:	75 23                	jne    7b1 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 78e:	c7 45 f0 b4 0b 00 00 	movl   $0xbb4,-0x10(%ebp)
 795:	8b 45 f0             	mov    -0x10(%ebp),%eax
 798:	a3 bc 0b 00 00       	mov    %eax,0xbbc
 79d:	a1 bc 0b 00 00       	mov    0xbbc,%eax
 7a2:	a3 b4 0b 00 00       	mov    %eax,0xbb4
    base.s.size = 0;
 7a7:	c7 05 b8 0b 00 00 00 	movl   $0x0,0xbb8
 7ae:	00 00 00 
  }
 ...
 804:	a3 bc 0b 00 00       	mov    %eax,0xbbc
      return (void*)(p + 1);
 ...
 80f:	eb 38                	jmp    849 <malloc+0xde>
    ...
    if(p == freep)
 811:	a1 bc 0b 00 00       	mov    0xbbc,%eax
