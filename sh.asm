...
runcmd(struct cmd *cmd)
{
  ...
  switch(cmd->type){
      ...
      1b:	8b 04 85 58 15 00 00 	mov    0x1558(,%eax,4),%eax
      22:	ff e0                	jmp    *%eax
  default:
    panic("runcmd");
      24:	c7 04 24 2c 15 00 00 	movl   $0x152c,(%esp)
  ...
  case EXEC:
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
      ...
      67:	c7 44 24 04 33 15 00 	movl   $0x1533,0x4(%esp)
      6e:	00 
  ...
  case REDIR:
    ...
    if(open(rcmd->file, rcmd->mode) < 0){
      ...
      ba:	c7 44 24 04 43 15 00 	movl   $0x1543,0x4(%esp)
      c1:	00 
  ...
  case PIPE:
    ...
    if(pipe(p) < 0)
     ...
     12e:	79 0c                	jns    13c <runcmd+0x13c>
      panic("pipe");
     130:	c7 04 24 53 15 00 00 	movl   $0x1553,(%esp)
...
getcmd(char *buf, int nbuf)
{
  ...
  printf(2, "$ ");
     211:	c7 44 24 04 70 15 00 	movl   $0x1570,0x4(%esp)
     218:	00 
     ...
     287:	eb 1f                	jmp    2a8 <main+0x3f>
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     290:	00 
     291:	c7 04 24 73 15 00 00 	movl   $0x1573,(%esp)
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     2fb:	00 
     2fc:	c7 44 24 04 7b 15 00 	movl   $0x157b,0x4(%esp)
     303:	00 
...
panic(char *s)
{
  ...
  printf(2, "%s\n", s);
     ...
     364:	c7 44 24 04 89 15 00 	movl   $0x1589,0x4(%esp)
     36b:	00 
...
fork1(void)
{
  ...
  if(pid == -1)
    ...
    panic("fork");
     391:	c7 04 24 8d 15 00 00 	movl   $0x158d,(%esp)
...
parsecmd(char *s)
{
  ...
  peek(&s, es, "");
     721:	c7 44 24 08 92 15 00 	movl   $0x1592,0x8(%esp)
     728:	00 
  ...
  if(s != es){
    ...
    printf(2, "leftovers: %s\n", s);
     ...
     74a:	c7 44 24 04 93 15 00 	movl   $0x1593,0x4(%esp)
     751:	00 
     752:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     759:	e8 8b 09 00 00       	call   10e9 <printf>
    panic("syntax");
     75e:	c7 04 24 a2 15 00 00 	movl   $0x15a2,(%esp)
...
parseline(char **ps, char *es)
{
  ...
  cmd = parsepipe(ps, es);
  while(peek(ps, es, "&")){
     7cb:	c7 44 24 08 a9 15 00 	movl   $0x15a9,0x8(%esp)
     7d2:	00 
  ...
  if(peek(ps, es, ";")){
     7e9:	c7 44 24 08 ab 15 00 	movl   $0x15ab,0x8(%esp)
     7f0:	00 
...
parsepipe(char **ps, char *es)
{
  ...
  if(peek(ps, es, "|")){
     86d:	c7 44 24 08 ad 15 00 	movl   $0x15ad,0x8(%esp)
     874:	00 
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
    ...
    if(gettoken(ps, es, &q, &eq) != 'a')
     ...
     92b:	c7 04 24 af 15 00 00 	movl   $0x15af,(%esp)
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     9d7:	c7 44 24 08 cc 15 00 	movl   $0x15cc,0x8(%esp)
     9de:	00 
...
parseblock(char **ps, char *es)
{
  ...
  if(!peek(ps, es, "("))
     a04:	c7 44 24 08 cf 15 00 	movl   $0x15cf,0x8(%esp)
     a0b:	00 
    ...
    panic("parseblock");
     a22:	c7 04 24 d1 15 00 00 	movl   $0x15d1,(%esp)
  ...
  if(!peek(ps, es, ")"))
     a65:	c7 44 24 08 dc 15 00 	movl   $0x15dc,0x8(%esp)
     a6c:	00 
    ...
    panic("syntax - missing )");
     a83:	c7 04 24 de 15 00 00 	movl   $0x15de,(%esp)
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ad8:	c7 44 24 08 cf 15 00 	movl   $0x15cf,0x8(%esp)
     adf:	00 
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(tok != 'a')
     ...
     b75:	74 0c                	je     b83 <parseexec+0xb1>
      panic("syntax");
     b77:	c7 04 24 a2 15 00 00 	movl   $0x15a2,(%esp)
    ...
    if(argc >= MAXARGS)
     ...
     ba8:	7e 0c                	jle    bb6 <parseexec+0xe4>
      panic("too many args");
     baa:	c7 04 24 f1 15 00 00 	movl   $0x15f1,(%esp)
  ...
  ret = parseredirs(ret, ps, es);
  while(!peek(ps, es, "|)&;")){
     bd2:	c7 44 24 08 ff 15 00 	movl   $0x15ff,0x8(%esp)
     bd9:	00 
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     c3c:	8b 04 85 04 16 00 00 	mov    0x1604(,%eax,4),%eax
     c43:	ff e0                	jmp    *%eax
  case EXEC:
    ecmd = (struct execcmd*)cmd;
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    1082:	0f b6 80 12 1b 00 00 	movzbl 0x1b12(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    11df:	75 09                	jne    11ea <printf+0x101>
          s = "(null)";
    11e1:	c7 45 f4 1c 16 00 00 	movl   $0x161c,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    12ab:	a1 ac 1b 00 00       	mov    0x1bac,%eax
...
free(void *ap)
{
  ...
  freep = p;
    ...
    1376:	a3 ac 1b 00 00       	mov    %eax,0x1bac
}
    137b:	c9                   	leave  
    137c:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  return freep;
    13ce:	a1 ac 1b 00 00       	mov    0x1bac,%eax
}
    13d3:	c9                   	leave  
    13d4:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    13ea:	a1 ac 1b 00 00       	mov    0x1bac,%eax
    13ef:	89 45 f0             	mov    %eax,-0x10(%ebp)
    13f2:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    13f6:	75 23                	jne    141b <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    13f8:	c7 45 f0 a4 1b 00 00 	movl   $0x1ba4,-0x10(%ebp)
    13ff:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1402:	a3 ac 1b 00 00       	mov    %eax,0x1bac
    1407:	a1 ac 1b 00 00       	mov    0x1bac,%eax
    140c:	a3 a4 1b 00 00       	mov    %eax,0x1ba4
    base.s.size = 0;
    1411:	c7 05 a8 1b 00 00 00 	movl   $0x0,0x1ba8
    1418:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    146e:	a3 ac 1b 00 00       	mov    %eax,0x1bac
      return (void*)(p + 1);
    ...
    if(p == freep)
    147b:	a1 ac 1b 00 00       	mov    0x1bac,%eax
...
void qthread_create(qthread_t *t, void *func, void *arg) {
    ...
    14b8:	83 ec 28             	sub    $0x28,%esp
  uint *stack = (uint*) malloc(STACKSIZE * sizeof(int));
    14bb:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
    14c2:	e8 0e ff ff ff       	call   13d5 <malloc>
    14c7:	89 45 f4             	mov    %eax,-0xc(%ebp)
  stack += STACKSIZE;
    14ca:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
  *t = threadop(0, func, arg, stack);
    14d1:	8b 45 f4             	mov    -0xc(%ebp),%eax
    14d4:	89 44 24 0c          	mov    %eax,0xc(%esp)
    14d8:	8b 45 10             	mov    0x10(%ebp),%eax
    14db:	89 44 24 08          	mov    %eax,0x8(%esp)
    14df:	8b 45 0c             	mov    0xc(%ebp),%eax
    14e2:	89 44 24 04          	mov    %eax,0x4(%esp)
    14e6:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    14ed:	e8 0f fb ff ff       	call   1001 <threadop>
    14f2:	8b 55 08             	mov    0x8(%ebp),%edx
    14f5:	89 02                	mov    %eax,(%edx)
}
    14f7:	c9                   	leave  
    14f8:	c3                   	ret    

000014f9 <qthread_mutex_init>:
...
int qthread_mutex_init(qthread_mutex_t *mutex, qthread_mutexattr_t *attr) {
  ...
  mutex->locked = 0;
    ...
    14ff:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  return 0;
...
int qthread_cond_init(qthread_cond_t *cond, qthread_condattr_t *attr) {
  ...
  cond->waiting.head = 0;
    ...
    1512:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  cond->waiting.tail = 0;
    1518:	8b 45 08             	mov    0x8(%ebp),%eax
    151b:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
